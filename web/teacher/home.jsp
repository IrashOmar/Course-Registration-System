...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
                <form action="addcourse.jsp?lecid=<%=lecid%>" method="post">
                    
                    
                    <div class="mb-3">
                        <label class="col-auto">Course ID</label>
                        <input name="courseid" type="text" class="form-control" placeholder="e.g. CSE3209" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>      
                    
                    <div class="mb-3">
                        <label class="col-auto">Course Name</label>
                        <input name="coursename" type="text" class="form-control" placeholder="e.g. Basic Programming" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>    
                    <div class="mb-3">
                        ...
                        String data = "select * from lecturer where lecid='" + lecid + "'";
                       
                        res = stat.executeQuery(data);
                        String name="";
                        while(res.next()){
                         name=res.getString("lecname"); 
                        }
                                                  

                        %>
                        
                        <input name="lecturer" type="text" class="form-control" value="<%=name%>" readonly style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                    
                      <div class="mb-3">
                        <label class="col-auto">Credit Hour</label>
                        <input name="credit" type="number" class="form-control" placeholder="e.g. 3" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
                  
                  
                    <input name="submit" value="Insert Course" type="submit" class="btn btn-primary form-control">
                </form>
            </div>
