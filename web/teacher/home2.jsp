            ...
            <div class="container">
                <form action="addcourse2.jsp" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="courseid" type="text" class="form-control" placeholder="e.g. KIM3209" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>      
                    
                    <div class="mb-3">
                        <label class="col-auto">Course Name</label>
                        <input name="coursename" type="text" class="form-control" placeholder="e.g. Basic Chemistry" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>    
                    <div class="mb-3">
                        <label class="col-auto">Lecturer</label>
                        <input name="lecturer" type="text" class="form-control" placeholder="e.g. Profesor Azra" style="border-radius: 5px 5px 5px 5px;" required>
                    </div>
