        ...
        <div class="wrapper">
            ...
            %>
                <ul class="list-unstyled components">
                    <li>
                        <a href="editCourse2.jsp?userid=<%=userid%>" class="text">
                            <i class="fas fa-book"></i>&nbsp&nbspCourse Details</a>
                    </li>

                    <li class="active">
                        <a href="Print.jsp?userid=<%=userid%>">
...
<%
     String host = "jdbc:mysql://localhost:3306/courseregistration";
                       ...
                       ResultSet res1 = null;
                        ...
                        String data = "select * from course2 where userid ='"+userid+"'";
                        String data1 = "select * from student where userid ='"+userid+"'";
...
%>
                    ...
                    <div class="invoice-box">
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr class="top">
                                <td colspan="2">
                                    <table>
                                        <tr>
                                            <td class="title">
                                                <b> Student ID : &emsp; <%=res1.getString("userid") %> </b>
                                                <br /> <br />
                                                <b> Student Name: &emsp;  <%=res1.getString("stuname")%></b>
                                                <br /><br />
                                            </td>
                                            <td>
                                               <br>
                            ...
                            <tr class="heading">
                                <td>
                                    Course Details : <br> Course Id
                                </td>
                                <td><br> Course Name</td>
                                <td><br> Lecturer's Name</td>
                                <td><br> Credit Hour</td>
                            </tr>
                         <%
